...
public class MaterialMenuView extends View implements MaterialMenu {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        try {
            int color = attr.getColor(R.styleable.MaterialMenuView_mm_color, Color.WHITE);
            ...
            int pressedDuration = attr.getInteger(R.styleable.MaterialMenuView_mm_pressedDuration, 400);
