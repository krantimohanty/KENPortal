...
import com.kenportal.users.custom_searchview.animation.ReverseInterpolator;
import com.kenportal.users.custom_searchview.animation.SupportAnimator;
import com.kenportal.users.custom_searchview.animation.ViewAnimationUtils;
...
//        toggleSearch();
    ...
    public void setDrawerLogo(Drawable icon) {
        //drawerLogo.setImageDrawable(null);
    }
...
//
//        Log.i("atag", e.getKeyCode() + "::::::::" + KeyEvent.KEYCODE_BACK + ":::::::::::::::" + getVisibility() + ":::::::" + View.VISIBLE);
//
...
//                Log.i("atag","::::::::::");
//
//                hideCircularly((Activity) context);
////            }
//            return true;
//        }
//
