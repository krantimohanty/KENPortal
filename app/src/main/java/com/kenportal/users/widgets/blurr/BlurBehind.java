package com.kenportal.users.widgets.blurr;
...
/**
 * Created by mantosh on 1/5/2016.
 */
public class BlurBehind {
    ...
    public void setBackground(RelativeLayout activity) {
        if (mImageCache.size() != 0) {
            ...
            activity.setBackgroundDrawable(bd);
